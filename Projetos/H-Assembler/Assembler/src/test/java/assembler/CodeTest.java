...
public class CodeTest  {
    ...
    public void testCode_Destine() {
		...
		try {
			...
			assertTrue("addw %S, %D, %A"	,Code.dest(new String[] {"addw","%S","%D","%A"}).equals("1010"));
			...
			assertTrue("subw %D (%A) %A",Code.dest(new String[] {"subw","%D","(%A)","%A"}).equals("1001"));
			assertTrue("rsubw %D (%A) %A",Code.dest(new String[] {"rsubw","%D","(%A)","%A"}).equals("1001"));

			assertTrue("subw %D (%A) %S",Code.dest(new String[] {"subw","%D","(%A)","%S"}).equals("0101"));
			assertTrue("rsubw %D (%A) %S",Code.dest(new String[] {"rsubw","%D","(%A)","%S"}).equals("0101"));
    ...
    public void testCode_Computation() {
		...
		try {
        	...
        	assertTrue("decw %D",Code.comp(new String[] {"decw","%D"}).equals("00000110"));
        	...
        	assertTrue("negw %A",Code.comp(new String[] {"negw","%A"}).equals("00110001"));
