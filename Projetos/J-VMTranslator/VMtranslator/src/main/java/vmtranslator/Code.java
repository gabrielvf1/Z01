...
//----------------------------MOVE SP-------------------------------
            ...
            commands.add(("movw %S, (%A)"));
//------------------------------------------------------------------
            commands.add(("movw (%A), %D")); //y
            commands.add(("decw %A"));//x
            ...
            commands.add(("leaw %ENDe, %A"));
            commands.add(("je %A"));
            commands.add(("nop"));

            commands.add(("movw (%A), %S"));
            commands.add(("leaw $0000000000000000, %A"));
            commands.add(("movw %S, (%A)"));
